...
<body data-theme="light">
  ...
  <div id="settings-panel" class="settings-panel hidden">
    ...
    <div class="settings-row">
      <label>
        <span id="label-retention-en">Snapshot retention (days)</span>
        <span id="label-retention-ru" class="hidden">Хранение снапшотов (дни)</span>
      </label>
      <input type="number" min="1" id="setting-retention" placeholder="30" />
    </div>
  ...
  <script>
    ...
    function setLang(lang) {
      ...
      const ids = [
        ...
        ["label-retention-en", "label-retention-ru"],
    ...
    async function saveSettings() {
      const payload = {
        ...
        snapshot_retention_days: Number(
          document.getElementById("setting-retention").value || 30
        ),
      };
